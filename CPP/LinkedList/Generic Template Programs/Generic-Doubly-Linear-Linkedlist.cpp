...
//  Description :  This application performs all operations of Doubly linear linked list for any given datatype.                                                   
...
int main()
{
    ...
    cout << ("00 : Terminate the application\n");
    ...
    while (iChoice != 0)
    {
        ...
        case 00:
            cout << ("\nThankyou for using Linked List...\n\n");
            break;
